...
admin=['s9SglmEcX0Rn7CffRSZs7flICTXb9vs1AAViXH3sSbs',lineMID]
...
settings = {
    ...
    "welcome":"สวัสดีคนมาใหม่\มาใหม่แก้ผ้า",
    "kick":"งิเตะทมอยยย  ⊙﹏⊙",
    "bye":"ไปซ่ะละ ลาก่อยยย",
    "Respontag":"แทคทำไมที่รัก คิดถึงหรอจ้ะ!",
    "eror":"ใช้คำสั่งอะไร ผมไม่เข้าใจ!",
    "spam":{},
    "invite": {},
    "winvite": False,
    "pnharfbot": {},
    ...
    "message":"บัญชีนี้ถูกป้องกันโดย พี่เซ ระบบได้บล็อคคุณอัตโนมัติ!",
    "comment":"""ŚẾL₣ВΌŦ BY: พี่เซ 
╔══════════════┓
╠       พี่เซ
╚══════════════┛""",
    "userAgent": [
